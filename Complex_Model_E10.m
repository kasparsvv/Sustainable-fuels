...
gamma_comb_out = 1.235839461630529;
gamma_comb_in = 1.360165519141158;
...
efficiency = W_E10/totaldQcomb*100;
...
function [dQcomb] = QModel(Ca,CaS,CaD,mfuel,Q_LHV_E10)
    ...
    dQcomb = Q_LHV_E10 * mfuel * n * a * ((1 - xb) / CaD) .* ((Ca - CaS) / CaD) .^ (n - 1); % Heat release, Formula from project handbook page 14
